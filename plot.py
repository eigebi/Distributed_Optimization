...
L5 = np.load('L_truth_non_convex_p.npy')
...
O5 = np.load('L_truth_non_convex_p.npy')
...
plt.plot(L5.reshape(-1),label='Lagrange function penalty')
plt.plot(O5.reshape(-1),label='Objective Function penalty')
