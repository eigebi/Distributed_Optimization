    ...
    for iteration in range(num_iteration):
        ...
        for frame in range(num_frame):
            ...
            for _ in range(2):
                ...
                # this data is unnecessary when we have the true gradient
                data_iteration.append(_x, r_p, L_truth)

                # problem may lie in too few lambda data
        ...
        for _ in range(1):
            ...
            id_sample = sample(range(len(data_iteration.x_past)),min(25,len(data_iteration.x_past)))
